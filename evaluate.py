...
def main(args):
    ...
    chosen_output_token_ids = torch.tensor(data["chosen_output_token_ids"]) if chosen_output_token_ids in data else None
    rejected_output_token_ids = torch.tensor(data["rejected_output_token_ids"]) if rejected_output_token_ids in data else None
